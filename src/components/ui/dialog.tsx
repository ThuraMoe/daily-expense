 ...
 * DialogContent
 *
 * Centered modal panel containing the dialog body. Renders inside a Portal
 * so it always layers above all page content.
 */
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-xl p-1.5 text-muted-foreground transition-colors hover:bg-muted hover:text-foreground focus:outline-none focus-visible:ring-2 focus-visible:ring-ring">
        <X className="h-4 w-4" />
 ...
 * DialogHeader
 *
 * Vertically stacked container for the dialog title and description.
 */
 ...
 * DialogTitle
 *
 * Accessible dialog heading. Required by Radix for screen readers.
 */
 ...
 * DialogDescription
 *
 * Optional secondary text below the title. Linked to the dialog for accessibility.
 */
